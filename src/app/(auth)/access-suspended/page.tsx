  ...
  return (
    <div className="min-h-screen bg-[#f8f7f4] px-4 py-12 sm:px-6">
      <div className="mx-auto max-w-md rounded-3xl border border-orange-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <p className="mt-3 text-sm text-[#6b7280]">
          Support: <a href="mailto:support@primepetfood.com" className="font-medium text-[#ea580c] underline">support@primepetfood.com</a>
        </p>
        <div className="mt-6 flex flex-col gap-2 sm:flex-row">
          <Link
            href="/catalog"
            className="inline-flex items-center justify-center rounded-xl bg-[#ea580c] px-5 py-2.5 text-sm font-semibold text-white"
          >
            Browse our catalog
          </Link>
          <Link
