...
export default function PrivateLabelYakChewsPage() {
  return (
    <main className="min-h-screen bg-[#f8f7f4] text-[#111827]">
      ...
      <section className="border-y border-[#e7e4dc] bg-white py-10">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="mb-4 text-xl font-semibold text-[#111827]">Who private label is for</h2>
      ...
      <section className="py-12">
        <div className="mx-auto max-w-6xl px-6">
          <BenefitGrid
            heading="Private label program features"
            subheading="Your brand on our quality product — everything you need to launch."
      ...
      <section className="mx-auto max-w-6xl px-6 py-12">
        <CTABlock
          heading="Ready to launch your private label yak chew line?"
          subheading="Contact us to discuss your volume, packaging vision, and timeline. We will provide a custom quote."
      ...
      <section className="border-t border-[#e7e4dc] bg-[#111827] py-12">
        <div className="mx-auto max-w-6xl px-6 text-center">
          <h2 className="text-2xl font-semibold text-white">
            Build your brand on the best yak chew in the market
          </h2>
          <p className="mt-3 text-sm text-[#9ca3af]">
            Request a private label quote and our team will walk you through the process.
          </p>
